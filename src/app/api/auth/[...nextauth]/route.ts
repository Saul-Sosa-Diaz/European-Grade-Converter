 ...
 *
 * @description This file contain the route to authenticate the application.
 */
...
// Extend the session to include role
  ...
  providers: [
    Credentials({
      ...
      async authorize(credentials) {
        try {
          const databaseAdapter = createDatabaseAdapter().getdbAuthRepository()
