...
export class GermanyGradeConverter implements ICountryConverter {
  private gradeRanges: GradeRange[] = [
    { min: 1.0, max: 1.5, base: 9, top: 10, factor: 0.2 }, // 9.0 - 10.0 (por cada 1 unidad en alemania, en españa son 0.20, (1 punto /5 unidades alemania))
    { min: 1.6, max: 2.0, base: 8.0, top: 8.9, factor: 0.2 }, // 8 - 8.9 (por cada 1 unidad en alemania, en españa son 0.20, (1 punto /5 unidades alemania))
    ...
    { min: 3.1, max: 3.5, base: 6.0, top: 6.9, factor: 0.2 }, // 6 - 6.9 (por cada 1 unidad en alemania, en españa son 0.20, (1 punto /5 unidades alemania))
    { min: 3.6, max: 4.0, base: 5.0, top: 5.9, factor: 0.2 }, // 5.0 - 5.9  (por cada 1 unidad en alemania, en españa son 0.20, (1 punto /5 unidades alemania))
