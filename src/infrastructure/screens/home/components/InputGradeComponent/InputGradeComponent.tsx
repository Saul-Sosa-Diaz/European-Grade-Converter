 ...
 *
 * @file This file contains the implementation of the InputGrade component.
 *
 * @date February 19, 2025
 * @description This file defines the InputGrade component used in the home screen.
 * @author Saul Sosa
 */
...
import { customParseFloat } from "@/infrastructure/screens/home/components/InputGradeComponent/UtilsInputGradeComponent";
...
export const InputGrade = () => {
  ...
  const handleGradeChange = (
    ...
    if (countryFrom.evaluationType === EvaluationType.CONTINUOUS) {
