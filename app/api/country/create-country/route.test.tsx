 ...
 *
 * @description This file constains the tests api route  to create a country.
 */
...
import { POST as createCountryPOST } from "./route";
...
describe('POST /create-country', () => {
    ...
    it('should return 401 if session is not found', async () => {
        ...
        const response = await createCountryPOST(request);
    ...
    it('should create country and log user activity', async () => {
        (getServerSession as jest.Mock).mockResolvedValue({ user: { name: 'testUser' } });
        ...
        expect(databaseAdapterMock.getDBCountryRepository().createCountry).toHaveBeenCalledWith({
            countryid: null,
            countrycode: 'US',
            countryname: 'United States'
        });
